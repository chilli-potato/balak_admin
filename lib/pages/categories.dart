...
import 'package:stud_admin/models/category.dart';
...
class _CategoriesState extends State<Categories> {
  ...
  Future _updateCategory(String categoryTimestamp) async {
    final DocumentReference ref =
        firestore.collection(collectionName).doc(categoryTimestamp);
    await ref.update({
      'name': nameCtrl1.text,
  ...
  void openEditDialog(String oldCategoryName, String oldThumbnailUrl,
              ...
              Form(
                  ...
                  child: Column(
                    children: <Widget>[
                      TextFormField(
                        decoration: inputDecoration(
                            'Enter Category Name', 'Category Name', nameCtrl1),
