...
import 'package:stud_admin/config/config.dart';
import 'package:stud_admin/customized_packages/vertical_tabs.dart';
import 'package:stud_admin/pages/admin.dart';
import 'package:stud_admin/pages/articles.dart';
import 'package:stud_admin/pages/featured.dart';
import 'package:stud_admin/pages/notifications.dart';
import 'package:stud_admin/pages/settings.dart';
import 'package:stud_admin/pages/sign_in.dart';
import 'package:stud_admin/pages/categories.dart';
import 'package:stud_admin/pages/upload_content.dart';
import 'package:stud_admin/pages/users.dart';
import 'package:stud_admin/utils/next_screen.dart';
import 'package:stud_admin/widgets/cover_widget.dart';
